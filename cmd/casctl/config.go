...
type configFlags struct {
	...
	AllowConnectionToDifferentVersions bool   `short:"a" long:"allow-connection-to-different-versions" description:"Allow connections to versions different than casctl's version'"`
...
func parseConfig() (*configFlags, error) {
	...
	parser.Usage = "casctl [OPTIONS] [COMMAND] [COMMAND PARAMETERS].\n\nCommand can be supplied only if --json is not used." +
		"\n\nUse `casctl --list-commands` to get a list of all commands and their parameters." +
