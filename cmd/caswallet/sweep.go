...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libcaswallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libcaswallet.PyrinwalletdUTXOsTolibcaswalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
