...
// PyrinwalletdUTXOsTolibcaswalletUTXOs converts a  []*pb.UtxosByAddressesEntry to a []*libcaswallet.UTXO
func PyrinwalletdUTXOsTolibcaswalletUTXOs(caswalletdUtxoEntires []*pb.UtxosByAddressesEntry) ([]*UTXO, error) {
	UTXOs := make([]*UTXO, len(caswalletdUtxoEntires))
	for i, entry := range caswalletdUtxoEntires {
