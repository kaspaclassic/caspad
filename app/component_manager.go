...
// Start launches all the caspad services.
...
// Stop gracefully shuts down all the caspad services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("caspad is already in the process of shutting down")
		return
	}

	log.Warnf("caspad shutting down")
