...
// ServiceFlag identifies services supported by a caspa peer.
...
// PyrinpyiNet represents which caspa network a message belongs to.
type PyrinpyiNet uint32

// Constants used to indicate the message caspa network. They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// Mainnet represents the main caspa network.
...
// bnStrings is a map of caspa networks back to their constant names for
// pretty printing.
