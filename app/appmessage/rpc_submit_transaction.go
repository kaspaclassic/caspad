...
// RPCTransaction is a caspad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a caspad transaction input representation
...
// RPCScriptPublicKey is a caspad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a caspad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a caspad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a caspad utxo entry representation meant to be used
// over RPC
