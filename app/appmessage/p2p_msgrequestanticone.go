...
// MsgRequestAnticone implements the Message interface and represents a caspa
...
// NewMsgRequestAnticone returns a new caspa RequestPastDiff message that conforms to the
