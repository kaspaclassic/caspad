...
// MsgRequestAddresses implements the Message interface and represents a caspa
...
// NewMsgRequestAddresses returns a new caspa RequestAddresses message that conforms to the
