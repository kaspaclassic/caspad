...
// MsgRequestAddresses implements the Message interface and represents a pyrin
...
// NewMsgRequestAddresses returns a new pyrin RequestAddresses message that conforms to the
