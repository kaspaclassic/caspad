...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a caspa
...
// NewMsgDoneBlocksWithTrustedData returns a new caspa DoneBlocksWithTrustedData message that conforms to the
// Message interface.
