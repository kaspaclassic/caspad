...
// MsgIBDChainBlockLocator implements the Message interface and represents a caspa
...
// NewMsgIBDChainBlockLocator returns a new caspa locator message that conforms to
