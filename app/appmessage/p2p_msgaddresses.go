...
// caspa Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a caspa
// Addresses message.
...
// NewMsgAddresses returns a new caspa Addresses message that conforms to the
