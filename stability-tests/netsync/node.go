...
func setupSyncee() (*rpc.Client, func(), error) {
	...
	synceeDataDir, err := useDirOrCreateTemp(activeConfig().SynceeDataDirectory, "syncee-caspad-data-dir")
	if err != nil {
		return nil, nil, err
	}
...
func setupSyncer() (*rpc.Client, func(), error) {
	...
	syncerDataDir, err := useDirOrCreateTemp(activeConfig().SyncerDataDirectory, "syncer-caspad-data-dir")
	if err != nil {
		return nil, nil, err
	}
