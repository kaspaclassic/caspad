...
const miningAddress = "caspadev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDowncaspad := common.RuncaspadForTesting(t, "caspad-daa-test", rpcAddress)
	defer tearDowncaspad()
