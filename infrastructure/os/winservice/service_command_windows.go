...
// installService attempts to install the caspad service. Typically this should
...
// removeService attempts to uninstall the caspad service. Typically this should
...
// startService attempts to Start the caspad service.
