...
GetCurrentNetworkRequestMessage requests the network caspad is currently running against.
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| payAddress | [string](#string) |  | Which caspa address should the coinbase block reward transaction pay into |
...
| ----- | ---- | ----- | ----------- |
| block | [RpcBlock](#protowire.RpcBlock) |  |  |
| isSynced | [bool](#bool) |  | Whether caspad thinks that it&#39;s synced. Callers are discouraged (but not forbidden) from solving blocks when caspad is not synced. That is because when caspad isn&#39;t in sync with the rest of the network there&#39;s a high chance the block will never be accepted, thus the solving effort would have been wasted. |
| error | [RPCError](#protowire.RPCError) |  |  |
...
GetPeerAddressesRequestMessage requests the list of known caspad addresses in the
...
currently connected to this caspad.
...
| isOutbound | [bool](#bool) |  | Whether this caspad initiated the connection |
| timeOffset | [int64](#int64) |  |  |
| userAgent | [string](#string) |  |  |
| advertisedProtocolVersion | [uint32](#uint32) |  | The protocol version that this peer claims to support |
| timeConnected | [int64](#int64) |  | The timestamp of when this peer connected to this caspad |
...
AddPeerRequestMessage adds a peer to caspad&#39;s outgoing connection list.
This will, in most cases, result in caspad connecting to said peer.
...
parent chain from some startHash to this caspad&#39;s current virtual
...
GetBlockCountRequestMessage requests the current number of blocks in this caspad.
...
ShutDownRequestMessage shuts down this caspad.
...
This call is only available when this caspad was started with `--utxoindex`
...
GetUtxosByAddressesRequestMessage requests all current UTXOs for the given caspad addresses
