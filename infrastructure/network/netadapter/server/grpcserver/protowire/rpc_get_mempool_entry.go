...
func (x *PyipadMessage_GetMempoolEntryRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PyipadMessage_GetMempoolEntryRequest is nil")
	}
	return x.GetMempoolEntryRequest.toAppMessage()
}

func (x *PyipadMessage_GetMempoolEntryRequest) fromAppMessage(message *appmessage.GetMempoolEntryRequestMessage) error {
...
func (x *PyipadMessage_GetMempoolEntryResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PyipadMessage_GetMempoolEntryResponse is nil")
	}
	return x.GetMempoolEntryResponse.toAppMessage()
}

func (x *PyipadMessage_GetMempoolEntryResponse) fromAppMessage(message *appmessage.GetMempoolEntryResponseMessage) error {
	var rpcErr *RPCError
