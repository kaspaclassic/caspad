...
func (x *PyipadMessage_GetBlockDagInfoRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PyipadMessage_GetBlockDagInfoRequest is nil")
	}
	return &appmessage.GetBlockDAGInfoRequestMessage{}, nil
}

func (x *PyipadMessage_GetBlockDagInfoRequest) fromAppMessage(_ *appmessage.GetBlockDAGInfoRequestMessage) error {
	x.GetBlockDagInfoRequest = &GetBlockDagInfoRequestMessage{}
	return nil
}

func (x *PyipadMessage_GetBlockDagInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PyipadMessage_GetBlockDagInfoResponse is nil")
	}
...
func (x *PyipadMessage_GetBlockDagInfoResponse) fromAppMessage(message *appmessage.GetBlockDAGInfoResponseMessage) error {
	var err *RPCError
