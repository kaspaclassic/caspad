...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether caspad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when caspad is not synced.
	// That is because when caspad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this caspad initiated the connection
	...
	// The timestamp of when this peer connected to this caspad
