...
func (x *PyipadMessage_RequestBlockLocator) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *PyipadMessage_RequestBlockLocator) fromAppMessage(msgGetBlockLocator *appmessage.MsgRequestBlockLocator) error {
