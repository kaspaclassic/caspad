...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := caspad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = caspad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = caspad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
