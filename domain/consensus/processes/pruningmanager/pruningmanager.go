...
import (
	...
	"github.com/kaspaclassic/caspad/domain/consensus/utils/multiset"
...
// This is a sanity test, to make sure that caspad doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
