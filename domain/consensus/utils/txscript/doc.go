/*
Package txscript implements the caspa transaction script language.

This package provides data structures and functions to parse and execute
caspa transaction scripts.

# Script Overview

Pyrin transaction scripts are written in a stack-base, FORTH-like language.

The caspa script language consists of a number of opcodes which fall into
...
Typical caspa scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend caspa.
